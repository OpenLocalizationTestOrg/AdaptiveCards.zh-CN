...
## <a name="example-create-an-adaptivecard-and-serialize-to-json"></a>示例:创建 AdaptiveCard 并序列化为 JSON
...
## <a name="example-parse-an-adaptivecard-from-json"></a>示例:分析 JSON 中的 AdaptiveCard
